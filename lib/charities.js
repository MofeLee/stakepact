...
Schema.Contact = new SimpleSchema({
  ...
  updatedAt: {
    type: Date,
    autoValue: function() {
      if (this.field('name').isSet || this.field('email').isSet || this.field('phone').isSet && this.isUpdate) {
        return new Date();
      }
    },
    denyInsert: true,
...
Schema.WePay = new SimpleSchema({
  ...
  updatedAt: {
    type: Date,
    autoValue: function() {
      if (this.field('access_token').isSet || this.field('account_id').isSet && this.isUpdate) {
        return new Date();
      }
    },
    denyInsert: true,
