    ...
    <div class="row text-center text-uppercase secondary-text">
      <div class="col-xs-8 col-xs-offset-2">
        <ul class="search-list">
          <li class="col-xs-12 text-left" ng-repeat="charity in charities | filter: {name: stakesctrl.search}">
  ...
  <div class="row text-center" ng-show="selectedCharity">
    ...
    <div class="col-xs-12">
      <form name="stakesForm" ng-submit="stakesctrl.submit()" novalidate>
        ...
        <div class="row text-center" ng-show="stakesctrl.hasCreditCardId">
          <div class="col-xs-12" ng-show="!stakesctrl.cardType">
            <div class="btn primary-button text-uppercase" style="margin: 1vw" ng-click="stakesctrl.cardType = 'existing credit card'">existing credit card</div>
            <div class="btn primary-button text-uppercase" style="margin: 1vw" ng-click="stakesctrl.cardType = 'new credit card'">new credit card</div>
          </div>
          <h1 ng-show="stakesctrl.cardType" class="col-xs-12 text-uppercase secondary-text" style="font-weight: 700;">{{stakesctrl.cardType}}<a ng-click="stakesctrl.cardType = null;"><sup><span class="glyphicon glyphicon-remove"> </span></sup></a></h1>
        </div>
        ...
        <div class="row">
          <div class="col-xs-offset-3 col-xs-6 text-uppercase">
            ...
            <div class="row" ng-show="!stakesctrl.hasCreditCardId || stakesctrl.cardType === 'new credit card'">
        ...
        <br>
        <button type="submit" class="btn primary-button text-uppercase" ng-disabled="!stakesctrl.isCompleteStakesInfo() || !stakesctrl.isCompleteCreditCardInfo()">set stakes</button>
      </form>
    </div>
  </div>
</div>
